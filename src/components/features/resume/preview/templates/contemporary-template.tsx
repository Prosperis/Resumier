      ...
      {experience && experience.length > 0 && (
        <div className="mb-8">
          ...
          {experience.map((exp, idx) => (
            <div key={idx} className="mb-6 pb-4 border-l-2 pl-6" style={{ borderColor: `${primaryColor}40` }}>
        ...
        {education && education.length > 0 && (
          <div>
            ...
            {education.map((edu, idx) => (
              <div key={idx} className="mb-4 pb-4 border-l-2 pl-4" style={{ borderColor: `${primaryColor}40` }}>
              ...
              <div className="space-y-2">
                {typeof skills === 'object' && 'technical' in skills && Array.isArray(skills.technical) &&
                  skills.technical.map((skill: any, idx: number) => (
                    <div key={idx} className="text-sm text-gray-700 border-l-2 pl-3" style={{ borderColor: primaryColor }}>
                      {skill.name || skill}
                    </div>
                  ))}
              </div>
