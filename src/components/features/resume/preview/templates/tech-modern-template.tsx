      ...
      <div className="flex gap-6 p-8">
        <div className="flex-[2]">
          {personalInfo.summary && (
            <div className="mb-6">
              <h2 className="text-xl font-bold mb-2 border-b-2 pb-1" style={{ color: primaryColor, borderColor: primaryColor }}>
                About
              </h2>
                    ...
                    <div key={idx}>
                      ...
                      <div className="w-full bg-gray-200 rounded-full h-2 mt-1">
                        <div
                          ...
                          style={{ width: `${skill.level || 70}%`, backgroundColor: primaryColor }}
                        />
                      </div>
                    </div>
                  ))}
