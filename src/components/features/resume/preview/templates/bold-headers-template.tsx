...
export function BoldHeadersTemplate({ resume, config }: BoldHeadersTemplateProps) {
  ...
  return (
    <div className="mx-auto max-w-[21cm] bg-white text-gray-900 shadow-lg p-10">
      <div className="mb-8">
        <h1 className="text-5xl font-black mb-3" style={{ color: primaryColor }}>{personalInfo.name || "YOUR NAME"}</h1>
      ...
      {personalInfo.summary && (
        <div className="mb-8">
          <div className="p-6 text-2xl font-black text-white mb-4" style={{ backgroundColor: primaryColor }}>
            ABOUT
          </div>
      ...
      {experience && experience.length > 0 && (
        <div className="mb-8">
          <div className="p-6 text-2xl font-black text-white mb-4 flex items-center gap-3" style={{ backgroundColor: primaryColor }}>
          ...
          {experience.map((exp, idx) => (
            <div key={idx} className="mb-5 pl-2">
              <div className="flex justify-between items-start mb-2">
                ...
                <span className="text-sm text-gray-600 font-semibold">{exp.startDate} - {exp.current ? "PRESENT" : exp.endDate}</span>
              </div>
      ...
      <div className="grid grid-cols-2 gap-8">
        {education && education.length > 0 && (
          <div>
            <div className="p-4 text-xl font-black text-white mb-4 flex items-center gap-2" style={{ backgroundColor: primaryColor }}>
        ...
        <div>
          {skills && (
            <div className="mb-6">
              <div className="p-4 text-xl font-black text-white mb-4" style={{ backgroundColor: primaryColor }}>
                SKILLS
              </div>
