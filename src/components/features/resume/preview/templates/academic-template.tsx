  ...
  return (
    <div className="mx-auto max-w-[21cm] bg-white p-12 text-gray-900 shadow-lg font-serif">
      ...
      {personalInfo.summary && (
        <div className="mb-6">
          <h2 className="text-lg font-bold mb-2 border-b pb-1" style={{ borderColor: primaryColor, color: primaryColor }}>
            Research Interests
          </h2>
        ...
        <div className="mb-6">
          ...
          {education.map((edu, idx) => (
            <div key={idx} className="mb-4">
              ...
              <p>{edu.institution}</p>
              {edu.startDate && <p className="text-gray-600">{edu.startDate} - {edu.endDate}</p>}
            </div>
          ))}
        </div>
      )}
