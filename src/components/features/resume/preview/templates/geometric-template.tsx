...
export function GeometricTemplate({ resume, config }: GeometricTemplateProps) {
  ...
  return (
    <div className="mx-auto max-w-[21cm] bg-white text-gray-900 shadow-lg p-10 relative overflow-hidden">
      <div className="absolute top-0 right-0 w-64 h-64 opacity-5" style={{ backgroundColor: primaryColor }}>
      ...
      <div className="relative z-10">
        <div className="flex items-center gap-4 mb-6">
          <div className="w-16 h-16 flex items-center justify-center" style={{ backgroundColor: primaryColor }}>
            <Triangle className="h-10 w-10 text-white" />
          </div>
          <div>
            <h1 className="text-4xl font-bold" style={{ color: primaryColor }}>{personalInfo.name || "Your Name"}</h1>
          ...
          <div className="mb-6">
            ...
            {experience.map((exp, idx) => (
              <div key={idx} className="mb-4 relative pl-6">
                <div className="absolute left-0 top-2 w-3 h-3" style={{ backgroundColor: primaryColor }} />
            ...
            <div>
              ...
              {education.map((edu, idx) => (
                <div key={idx} className="mb-3 relative pl-6">
                  <div className="absolute left-0 top-1 w-3 h-3 rotate-45" style={{ backgroundColor: primaryColor }} />
