    ...
    <div className="mx-auto max-w-[21cm] bg-white text-gray-900 shadow-lg">
      ...
      <div className="p-8">
        {personalInfo.summary && (
          <div className="mb-6 p-4 rounded-lg border-l-4" style={{ backgroundColor: `${primaryColor}10`, borderColor: primaryColor }}>
        ...
        {experience && experience.length > 0 && (
          <div className="mb-6">
            <h2 className="text-2xl font-bold mb-4" style={{ color: primaryColor }}>Experience</h2>
            {experience.map((exp, idx) => (
              <div key={idx} className="mb-5 pl-4 border-l-2" style={{ borderColor: `${primaryColor}40` }}>
                <div className="flex justify-between items-start">
                  <div>
                    <h3 className="font-bold text-lg">{exp.position}</h3>
                    <p className="font-semibold" style={{ color: primaryColor }}>{exp.company}</p>
                  </div>
                  <span className="text-sm text-gray-600 px-2 py-1 rounded" style={{ backgroundColor: `${primaryColor}10` }}>
        ...
        <div className="grid grid-cols-2 gap-6">
          {skills && (
            <div>
              <h2 className="text-2xl font-bold mb-4" style={{ color: primaryColor }}>Skills</h2>
          ...
          {education && education.length > 0 && (
            <div>
              <h2 className="text-2xl font-bold mb-4" style={{ color: primaryColor }}>Education</h2>
