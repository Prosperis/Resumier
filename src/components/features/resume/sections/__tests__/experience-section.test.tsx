...
describe("ExperienceSection", () => {
  ...
  describe("Empty/Undefined Values", () => {
    it("handles undefined company", () => {
      const expWithUndefined = { ...mockExperience, company: undefined as unknown as string }
    ...
    it("handles undefined title", async () => {
      const user = userEvent.setup()
      const expWithUndefined = { ...mockExperience, title: undefined as unknown as string }
      render(<ExperienceSection {...defaultProps} experiences={[expWithUndefined]} />)
    ...
    it("handles undefined description", async () => {
      const user = userEvent.setup()
      const expWithUndefined = { ...mockExperience, description: undefined as unknown as string }
      render(<ExperienceSection {...defaultProps} experiences={[expWithUndefined]} />)
    ...
    it("handles undefined current", async () => {
      const user = userEvent.setup()
      const expWithUndefined = { ...mockExperience, current: undefined as unknown as boolean }
      render(<ExperienceSection {...defaultProps} experiences={[expWithUndefined]} />)
  ...
  describe("Award Input Values", () => {
    it("displays award input value from props", async () => {
      const user = userEvent.setup()
      const propsWithInput = { ...defaultProps, awardInputs: { "0": "Test Award" } }
