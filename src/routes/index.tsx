    ...
    <div className="container mx-auto p-8">
      <div className="mx-auto max-w-6xl space-y-20">
        ...
        <div className="relative space-y-8 text-center">
          ...
          <div className="absolute -top-10 right-1/4 h-48 w-48 rounded-full bg-blue-500/20 blur-3xl animate-pulse" style={{ animationDelay: '1s' }} />
          ...
          <div className="relative">
            <h1 className="relative inline-block">
              ...
              <br />
              <span className="bg-gradient-to-r from-fuchsia-600 via-pink-600 to-rose-600 bg-clip-text text-7xl font-black tracking-tighter text-transparent drop-shadow-lg animate-in fade-in slide-in-from-bottom-4 duration-1000" style={{ animationDelay: '200ms' }}>
                Resume
              </span>
              {/* Decorative elements */}
              <div className="absolute -right-8 top-0 h-3 w-3 rounded-full bg-purple-500 animate-ping" />
              <div className="absolute -left-8 bottom-4 h-2 w-2 rounded-full bg-pink-500 animate-ping" style={{ animationDelay: '500ms' }} />
            </h1>
          </div>
          
          <p className="text-muted-foreground mx-auto max-w-2xl text-2xl font-light leading-relaxed tracking-wide animate-in fade-in slide-in-from-bottom-4 duration-1000" style={{ animationDelay: '400ms' }}>
            Professional resume builder with <span className="font-semibold text-purple-600">AI-powered</span> features. 
            Create, customize, and download in <span className="font-semibold text-fuchsia-600">minutes</span>.
          </p>
          
          <div className="mt-12 flex justify-center gap-6 animate-in fade-in slide-in-from-bottom-4 duration-1000" style={{ animationDelay: '600ms' }}>
            <Button
              size="lg"
          ...
          {/* Stats bar */}
          <div className="mx-auto mt-16 flex max-w-3xl items-center justify-around rounded-2xl border border-purple-500/20 bg-gradient-to-r from-purple-500/5 via-fuchsia-500/5 to-pink-500/5 p-6 backdrop-blur-sm animate-in fade-in slide-in-from-bottom-4 duration-1000" style={{ animationDelay: '800ms' }}>
            ...
            <div className="text-center">
              <div className="text-3xl font-bold bg-gradient-to-r from-fuchsia-600 to-pink-600 bg-clip-text text-transparent">50+</div>
              <div className="text-sm text-muted-foreground">Templates</div>
            </div>
            <div className="h-12 w-px bg-gradient-to-b from-transparent via-purple-500/50 to-transparent" />
            <div className="text-center">
              <div className="text-3xl font-bold bg-gradient-to-r from-pink-600 to-rose-600 bg-clip-text text-transparent">4.9★</div>
        ...
        <div className="grid gap-8 md:grid-cols-2">
          ...
          <div className="group relative overflow-hidden rounded-3xl border border-violet-500/30 bg-gradient-to-br from-violet-500/10 via-purple-500/5 to-transparent p-8 backdrop-blur-sm transition-all duration-500 hover:scale-[1.02] hover:border-violet-500/50 hover:shadow-2xl hover:shadow-violet-500/20 animate-in fade-in slide-in-from-bottom-4 duration-1000" style={{ animationDelay: '1000ms' }}>
            ...
            <p className="text-muted-foreground relative text-lg leading-relaxed">
              Choose from a stunning variety of <span className="font-semibold text-violet-600">professional templates</span> tailored to different industries and experience levels.
            </p>
          ...
          <div className="group relative overflow-hidden rounded-3xl border border-fuchsia-500/30 bg-gradient-to-br from-fuchsia-500/10 via-pink-500/5 to-transparent p-8 backdrop-blur-sm transition-all duration-500 hover:scale-[1.02] hover:border-fuchsia-500/50 hover:shadow-2xl hover:shadow-fuchsia-500/20 animate-in fade-in slide-in-from-bottom-4 duration-1000" style={{ animationDelay: '1200ms' }}>
            ...
            <p className="text-muted-foreground relative text-lg leading-relaxed">
              Watch your resume <span className="font-semibold text-fuchsia-600">transform instantly</span> as you type. What you see is exactly what you'll get - no surprises.
            </p>
          ...
          <div className="group relative overflow-hidden rounded-3xl border border-blue-500/30 bg-gradient-to-br from-blue-500/10 via-cyan-500/5 to-transparent p-8 backdrop-blur-sm transition-all duration-500 hover:scale-[1.02] hover:border-blue-500/50 hover:shadow-2xl hover:shadow-blue-500/20 animate-in fade-in slide-in-from-bottom-4 duration-1000" style={{ animationDelay: '1400ms' }}>
            ...
            <p className="text-muted-foreground relative text-lg leading-relaxed">
              Download as <span className="font-semibold text-blue-600">high-quality PDF</span>, share online, or print. Your resume, your way, ready for any opportunity.
            </p>
          ...
          <div className="group relative overflow-hidden rounded-3xl border border-emerald-500/30 bg-gradient-to-br from-emerald-500/10 via-teal-500/5 to-transparent p-8 backdrop-blur-sm transition-all duration-500 hover:scale-[1.02] hover:border-emerald-500/50 hover:shadow-2xl hover:shadow-emerald-500/20 animate-in fade-in slide-in-from-bottom-4 duration-1000" style={{ animationDelay: '1600ms' }}>
            ...
            <p className="text-muted-foreground relative text-lg leading-relaxed">
              <span className="font-semibold text-emerald-600">Automatic cloud backup</span> keeps your resumes safe and accessible from any device, anywhere in the world.
            </p>
