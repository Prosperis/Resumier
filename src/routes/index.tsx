        ...
        <div className="mx-auto max-w-5xl space-y-24">
          ...
          <div className="space-y-10 text-center">
            ...
            <div className="space-y-6">
              ...
              <p className="mx-auto max-w-2xl text-xl text-muted-foreground leading-relaxed">
                Professional resume builder with AI-powered features. Create, customize, and
                download in minutes.
              </p>
            </div>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <div className="group rounded-xl border border-border bg-card p-8 transition-all hover:border-primary/20 hover:shadow-md">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Watch your resume transform instantly as you type. What you see is exactly what
                you'll get.
              </p>
            </div>
